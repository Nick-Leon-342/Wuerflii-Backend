...
router.get('/', async (req, res) => {
	...
	if (!cookies?.Wuerflii_RefreshToken) return res.status(401).send('No cookie found.')				//check for cookies and check for cookies with 'RefreshToken' properties (name of cookie)
